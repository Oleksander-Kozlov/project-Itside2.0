import{e as i,p as j}from"./pagination-shop-list-981641f4.js";const r=t=>t.map(({id:e,title:s,author:n,bookImage:l,categoryName:m,description:f,buyLinks:[{name:L,url:y},{name:S,url:x},{name:$,url:T}]})=>`<li class="item-shoppingList  js-item-book js-item-book" id = '${e}'>
